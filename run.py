...
navbar = dbc.NavbarSimple(
    brand='Amazon Ratings Prediction App',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Josh F', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:thejoshfowlkes@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/JoshFowlkes'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/josh-fowlkes-18844018a/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/beyond_brawn1'),   
                ], 
                className='lead'
            )
        )
